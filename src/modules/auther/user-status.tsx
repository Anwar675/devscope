          ...
          {isUserPanelOpen && (
            <div className="absolute right-0 top-14 w-72 rounded-xl border border-dev-border bg-dev-nav p-4 shadow-2xl backdrop-blur-xl">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-full bg-dev text-sm font-semibold text-dev-text">
                  {session?.user ? userInitial : <User className="h-5 w-5" />}
                </div>
